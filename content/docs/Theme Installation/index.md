...
3. Run the following command in your project to fetch the latest theme sources from GitHub:
    ...
    If you prefer to pin or update to a [specific release](https://github.com/babeneso/hugo-neso/releases) (example pins to `v0.1.0`):

    ```shell {linenos=true data-prompt=true}
    hugo mod get github.com/babeneso/hugo-neso@v0.1.0
    ```
